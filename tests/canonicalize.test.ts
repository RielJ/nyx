...
describe('findNonCanonicalClasses', () => {
  ...
  it('should detect h-[72px] as non-canonical (with rem)', () => {
    ...
    const diagnostics = findNonCanonicalClasses(designSystem, content, 'html', 'test.html', {
      rem: 16,
    })
  ...
  return <div className="h-[72px] p-[16px]">hello</div>
    ...
    const diagnostics = findNonCanonicalClasses(designSystem, content, 'tsx', 'test.tsx', {
      rem: 16,
    })
